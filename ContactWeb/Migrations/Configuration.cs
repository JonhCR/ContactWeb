        ...
        protected override void Seed(ContactWeb.Models.ApplicationDbContext context)
        {
            ...
            context.Contacts.AddOrUpdate(
                ...
                new Models.Contact
                {
                    ...
                    PhoneSecundary = "234-567-8901",
                    State = "IL"
                                    ,
                    StreetAddress1 = "Sickbay",
                    StreetAddress2 = "Starship Enterprise NCC-1701"
                                    ,
                    UserId = new Guid("0c5d0cb1-5546-49fd-b172-64cc2c9b9f8f")
                                    ,
                    zip = "98765"
                }
                , new Models.Contact
                ...
                , new Models.Contact
                {
                    ...
                    PhoneSecundary = "876-543-2109",
                    State = "CA"
                                    ,
                    StreetAddress1 = "Science Station 1",
                    StreetAddress2 = "Starship Enterprise NCC-1701"
                                    ,
                    UserId = new Guid("c45cfef8-8405-4bdb-862f-a27a42505a09")
                                    ,
                    zip = "76543-2109"
                }
                , new Models.Contact
